define(["require", "exports", "N/record", "./responseLogger"], function (require, exports, record, responseLogger_1) {
    ...
    function copyFields(config) {
        var fromRecord = config.fromRecord, _a = config.toRecord, toRecord = _a === void 0 ? record.create({ type: fromRecord.type }) : _a, _b = config.ignoreFields, ignoreFields = _b === void 0 ? [] : _b, _c = config.customFieldValues, customFieldValues = _c === void 0 ? {} : _c;
