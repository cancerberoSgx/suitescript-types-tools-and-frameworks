...
define(["require", "exports", "../../log/log", "./copySublist"], function (require, exports, log_1, copySublist_1) {
    "use strict";
    ...
    function copySublists(config) {
        ...
        log_1.log("cloneSublists starts: sublists: " + sublists.join(',') + ", fromRecord: " + fromRecord.id + ", toRecord: " + toRecord.id + ", dontSave: " + dontSave + ", customCloneSublistConfigs: " + Object.keys(customCloneSublistConfigs).join(','));
        ...
        log_1.log("cloneSublists ends: sublists: " + sublists.join(',') + ", fromRecord: " + fromRecord.id + ", toRecord: " + toRecord.id);
    }
