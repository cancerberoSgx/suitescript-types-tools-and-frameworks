...
import { ListRecordTypeResult } from '../../store/listRecordTypes/types'
...
class ListRecordTypesPage extends React.Component<AllProps> {
...
const mapStateToProps = ({ listRecordTypes }: ApplicationState) => ({
  ...
  // errors: teams.errors,
  asd: listRecordTypes.recordTypes,
