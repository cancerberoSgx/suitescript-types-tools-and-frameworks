...
// export class StateableComponent<P, S extends any = {}> extends StatelessComponent<P> implements IStateableComponent<P, S>{
//   state: S = {} as any
...
// interface IStateableComponent<P, S extends any = {}> extends IStatelessComponent<P>{
//   state: S
//   setState<K extends keyof S>(state: Pick<S, K> | S |null): void
//   getState(): S
// }
// export interface IScopeableComponent <P , S, Scope extends {props: P, state: S} ={props: P, state: S}> extends IStateableComponent<P, S>{
//   // this:Scope
//   getScope(): Scope
//   render(this: Scope): JSX.Element
// }
// // scope extends {getScope: never,readonly props:Readonly< P>, readonly state: S
// export class ScopeableComponent<P , S, Scope extends {props: P, state: S}= {props: P, state: S}   > extends StateableComponent<P, S> implements IScopeableComponent<P, S, Scope>{
//   // constructor(props: P) {
//   //   super(props)
//   // }
