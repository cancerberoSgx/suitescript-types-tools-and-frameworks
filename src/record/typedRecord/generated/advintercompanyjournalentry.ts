...
/** 
 * Advanced Intercompany Journal Entry Fields Definition.
 * Record's Internal Id: advintercompanyjournalentry. 
 * Supports Custom Fields: true 
 */
export interface advintercompanyjournalentryFields {
...
/** 
 * Advanced Intercompany Journal Entry Sublists Definition.
 * Record's Internal Id: advintercompanyjournalentry. 
 * Supports Custom Fields: true 
 */
export interface advintercompanyjournalentrySublists {
  ...
  line: {
    ...
    department: string;
    /** duetofromsubsidiary - Due To/From {Subsidiary}  */
    duetofromsubsidiary: string;
    /** eliminate - Eliminate  */
    eliminate: boolean;
    /** enddate - End Date  */
    enddate: Date;
    ...
    /** line -   */
    line: number;
    /** linebasecurrency - Base Currency  */
    linebasecurrency: string;
    /** linefxrate - Exchange Rate  */
    linefxrate?: number;
    /** linesubsidiary - Subsidiary  */
    linesubsidiary?: string;
    /** linetotalamt - Total Amount (Base Currency)  */
    linetotalamt: string;
    /** location - Location  */
    location: string;
    /** memo - Memo  */
