...
/** 
 * Journal Entry Fields Definition.
 * Record's Internal Id: journalentry. 
...
You can edit the exchange rate for this transaction only, or you can update the currency exchange rates list. */
  ...
  /**  */
  nextapprover?: string;
  /** Select the Nexus, if any, associated with this journal entry. */
  nexus?: string;
  /**  */
...
/** 
 * Journal Entry Sublists Definition.
 * Record's Internal Id: journalentry. 
 * Supports Custom Fields: true 
 */
export interface journalentrySublists {
