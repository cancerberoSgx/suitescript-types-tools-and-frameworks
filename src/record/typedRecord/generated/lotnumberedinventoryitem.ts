...
/** 
 * Lot Numbered Inventory Item Fields Definition.
 * Record's Internal Id: lotnumberedinventoryitem. 
 * Supports Custom Fields: true 
 */
export interface lotnumberedinventoryitemFields {
...
/** 
 * Lot Numbered Inventory Item Sublists Definition.
 * Record's Internal Id: lotnumberedinventoryitem. 
 * Supports Custom Fields: true 
 */
export interface lotnumberedinventoryitemSublists {
  ...
  locations: {
    ...
    /** locationstorepickupbufferstock - Store Pickup Buffer Stock  */
