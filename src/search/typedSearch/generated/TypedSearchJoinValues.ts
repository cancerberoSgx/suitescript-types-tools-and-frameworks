...
export const activitySearchJoinValues = [
...
export const billingrevenueeventSearchJoinValues = [
...
export const bomrevisionSearchJoinValues = [
...
export const campaignSearchJoinValues = [
...
export const chargeruleSearchJoinValues = [
...
export const entitySearchJoinValues = [
{id: 'campaignresponse', description: 'Campaign Response', actualName: 'Campaign'},
  {id: 'messages', description: 'Messages', actualName: 'Message'},
  {id: 'messagesfrom', description: 'Messages From', actualName: 'Message'},
  {id: 'messagesto', description: 'Messages To', actualName: 'Message'},
...
export const entityaccountmappingSearchJoinValues = [
...
export const fixedamountprojectrevenueruleSearchJoinValues = [
...
export const globalinventoryrelationshipSearchJoinValues = [
...
export const inboundshipmentSearchJoinValues = [
...
export const inventorycountSearchJoinValues = [

];

/** Inventory Detail (inventorydetail) Search Join values so they can be loaded dynamically. */
export const inventorydetailSearchJoinValues = [
...
export const itemaccountmappingSearchJoinValues = [
{id: 'accountingbook', description: 'Accounting Book', actualName: 'Accounting Book'},
  {id: 'department', description: 'Department', actualName: 'Department'},
  {id: 'destinationaccount', description: 'Destination Account', actualName: 'Account'},
  {id: 'location', description: 'Location', actualName: 'Location'},
...
export const landedcostSearchJoinValues = [

];

/** Lead (lead) Search Join values so they can be loaded dynamically. */
export const leadSearchJoinValues = [
{id: 'campaignresponse', description: 'Campaign Response', actualName: 'Campaign'},
  {id: 'contact', description: 'Contact', actualName: 'Contact'},
  {id: 'contactprimary', description: 'Contact (Primary)', actualName: 'Contact'},
  {id: 'job', description: 'Job', actualName: 'Job'},
...
export const locationSearchJoinValues = [
...
export const mfgplannedtimeSearchJoinValues = [
...
export const notetypeSearchJoinValues = [
{id: 'user', description: 'User', actualName: 'Employee'}
];

/** Opportunity (opportunity) Search Join values so they can be loaded dynamically. */
export const opportunitySearchJoinValues = [
...
export const orderscheduleSearchJoinValues = [

];

/** Originating Lead (originatinglead) Search Join values so they can be loaded dynamically. */
export const originatingleadSearchJoinValues = [
{id: 'msesubsidiary', description: 'Subsidiary', actualName: 'Subsidiary'},
  {id: 'originatinglead', description: 'Originating Lead', actualName: 'Lead'},
  {id: 'pricing', description: 'Pricing', actualName: 'Pricing'}
];
...
export const otherchargeitemSearchJoinValues = [

];

/** Other Name (othername) Search Join values so they can be loaded dynamically. */
export const othernameSearchJoinValues = [
{id: 'campaignresponse', description: 'Campaign Response', actualName: 'Campaign'},
  {id: 'contact', description: 'Contact', actualName: 'Contact'},
  {id: 'messages', description: 'Messages', actualName: 'Message'},
  {id: 'messagesfrom', description: 'Messages From', actualName: 'Message'},
...
export const othernamecategorySearchJoinValues = [
{id: 'user', description: 'User', actualName: 'Employee'}
];

/** Partner (partner) Search Join values so they can be loaded dynamically. */
export const partnerSearchJoinValues = [
{id: 'campaignresponse', description: 'Campaign Response', actualName: 'Campaign'},
  {id: 'contact', description: 'Contact', actualName: 'Contact'},
  {id: 'contactprimary', description: 'Contact (Primary)', actualName: 'Contact'},
  {id: 'customer', description: 'Customer', actualName: 'Customer'},
...
export const projecttaskassignmentSearchJoinValues = [

];

/** Project Template (projecttemplate) Search Join values so they can be loaded dynamically. */
export const projecttemplateSearchJoinValues = [
...
export const promotioncodeSearchJoinValues = [

];

/** Prospect (prospect) Search Join values so they can be loaded dynamically. */
export const prospectSearchJoinValues = [
{id: 'campaignresponse', description: 'Campaign Response', actualName: 'Campaign'},
  {id: 'contact', description: 'Contact', actualName: 'Contact'},
  {id: 'contactprimary', description: 'Contact (Primary)', actualName: 'Contact'},
  {id: 'job', description: 'Job', actualName: 'Job'},
...
export const solutionSearchJoinValues = [
...
export const subscriptionchangeorderSearchJoinValues = [

];

/** Subscription Line (subscriptionline) Search Join values so they can be loaded dynamically. */
export const subscriptionlineSearchJoinValues = [
...
export const subscriptionplanSearchJoinValues = [

];

/** Subsidiary (subsidiary) Search Join values so they can be loaded dynamically. */
export const subsidiarySearchJoinValues = [
{id: 'address', description: 'Address', actualName: 'Address'},
...
export const taskSearchJoinValues = [
{id: 'companycustomer', description: 'Company (Customer)', actualName: 'Customer'},
  {id: 'contact', description: 'Contact', actualName: 'Contact'},
  {id: 'employee', description: 'Employee', actualName: 'Employee'},
  {id: 'job', description: 'Job', actualName: 'Job'},
...
export const timeentrySearchJoinValues = [
...
export const timesheetSearchJoinValues = [
{id: 'employee', description: 'Employee', actualName: 'Employee'},
...
account: accountSearchJoinValues,
  ...
  accountingperiod: accountingperiodSearchJoinValues,
  accountingtransaction: accountingtransactionSearchJoinValues,
  activity: activitySearchJoinValues,
  address: addressSearchJoinValues,
  advintercompanyjournalentry: advintercompanyjournalentrySearchJoinValues,
  allocationschedule: allocationscheduleSearchJoinValues,
  amortizationschedule: amortizationscheduleSearchJoinValues,
  amortizationtemplate: amortizationtemplateSearchJoinValues,
  assemblybuild: assemblybuildSearchJoinValues,
  assemblyitem: assemblyitemSearchJoinValues,
  assemblyitembom: assemblyitembomSearchJoinValues,
  assemblyunbuild: assemblyunbuildSearchJoinValues,
  billingaccount: billingaccountSearchJoinValues,
  billingclass: billingclassSearchJoinValues,
  billingratecard: billingratecardSearchJoinValues,
  billingrevenueevent: billingrevenueeventSearchJoinValues,
  billingschedule: billingscheduleSearchJoinValues,
  bin: binSearchJoinValues,
  bintransfer: bintransferSearchJoinValues,
  binworksheet: binworksheetSearchJoinValues,
  blanketpurchaseorder: blanketpurchaseorderSearchJoinValues,
  bom: bomSearchJoinValues,
  bomrevision: bomrevisionSearchJoinValues,
  bulkownershiptransfer: bulkownershiptransferSearchJoinValues,
  bundleinstallationscript: bundleinstallationscriptSearchJoinValues,
  calendarevent: calendareventSearchJoinValues,
  campaign: campaignSearchJoinValues,
  campaignresponse: campaignresponseSearchJoinValues,
  campaigntemplate: campaigntemplateSearchJoinValues,
  cashrefund: cashrefundSearchJoinValues,
  cashsale: cashsaleSearchJoinValues,
  charge: chargeSearchJoinValues,
  chargerule: chargeruleSearchJoinValues,
  check: checkSearchJoinValues,
  classification: classificationSearchJoinValues,
  clientscript: clientscriptSearchJoinValues,
  cmscontent: cmscontentSearchJoinValues,
  cmscontenttype: cmscontenttypeSearchJoinValues,
  commercecategory: commercecategorySearchJoinValues,
  competitor: competitorSearchJoinValues,
  consolidatedexchangerate: consolidatedexchangerateSearchJoinValues,
  contact: contactSearchJoinValues,
  contactcategory: contactcategorySearchJoinValues,
  contactrole: contactroleSearchJoinValues,
  costcategory: costcategorySearchJoinValues,
  couponcode: couponcodeSearchJoinValues,
  creditcardcharge: creditcardchargeSearchJoinValues,
  creditcardrefund: creditcardrefundSearchJoinValues,
  creditmemo: creditmemoSearchJoinValues,
  currency: currencySearchJoinValues,
  customer: customerSearchJoinValues,
  customercategory: customercategorySearchJoinValues,
  customerdeposit: customerdepositSearchJoinValues,
  customermessage: customermessageSearchJoinValues,
  customerpayment: customerpaymentSearchJoinValues,
  customerpaymentauthorization: customerpaymentauthorizationSearchJoinValues,
  customerrefund: customerrefundSearchJoinValues,
  customerstatus: customerstatusSearchJoinValues,
  customersubsidiaryrelationship: customersubsidiaryrelationshipSearchJoinValues,
  customrecord: customrecordSearchJoinValues,
  deletedrecord: deletedrecordSearchJoinValues,
  department: departmentSearchJoinValues,
  deposit: depositSearchJoinValues,
  depositapplication: depositapplicationSearchJoinValues,
  descriptionitem: descriptionitemSearchJoinValues,
  discountitem: discountitemSearchJoinValues,
  downloaditem: downloaditemSearchJoinValues,
  emailtemplate: emailtemplateSearchJoinValues,
  employee: employeeSearchJoinValues,
  entity: entitySearchJoinValues,
  entityaccountmapping: entityaccountmappingSearchJoinValues,
  entitygroup: entitygroupSearchJoinValues,
  estimate: estimateSearchJoinValues,
  expensecategory: expensecategorySearchJoinValues,
  expensereport: expensereportSearchJoinValues,
  fairvalueprice: fairvaluepriceSearchJoinValues,
  file: fileSearchJoinValues,
  fixedamountprojectrevenuerule: fixedamountprojectrevenueruleSearchJoinValues,
  folder: folderSearchJoinValues,
  fulfillmentrequest: fulfillmentrequestSearchJoinValues,
  genericresource: genericresourceSearchJoinValues,
  giftcertificate: giftcertificateSearchJoinValues,
  giftcertificateitem: giftcertificateitemSearchJoinValues,
  globalaccountmapping: globalaccountmappingSearchJoinValues,
  globalinventoryrelationship: globalinventoryrelationshipSearchJoinValues,
  inboundshipment: inboundshipmentSearchJoinValues,
  intercompallocationschedule: intercompallocationscheduleSearchJoinValues,
  intercompanyjournalentry: intercompanyjournalentrySearchJoinValues,
  intercompanytransferorder: intercompanytransferorderSearchJoinValues,
  inventoryadjustment: inventoryadjustmentSearchJoinValues,
  inventorycostrevaluation: inventorycostrevaluationSearchJoinValues,
  inventorycount: inventorycountSearchJoinValues,
  inventorydetail: inventorydetailSearchJoinValues,
  inventoryitem: inventoryitemSearchJoinValues,
  inventorynumber: inventorynumberSearchJoinValues,
  inventorynumberbin: inventorynumberbinSearchJoinValues,
  inventorystatus: inventorystatusSearchJoinValues,
  inventorystatuschange: inventorystatuschangeSearchJoinValues,
  inventorytransfer: inventorytransferSearchJoinValues,
  invoice: invoiceSearchJoinValues,
  issue: issueSearchJoinValues,
  issueproduct: issueproductSearchJoinValues,
  issueproductversion: issueproductversionSearchJoinValues,
  item: itemSearchJoinValues,
  itemaccountmapping: itemaccountmappingSearchJoinValues,
  itembinnumber: itembinnumberSearchJoinValues,
  itemdemandplan: itemdemandplanSearchJoinValues,
  itemfulfillment: itemfulfillmentSearchJoinValues,
  itemgroup: itemgroupSearchJoinValues,
  itemlocationconfiguration: itemlocationconfigurationSearchJoinValues,
  itemreceipt: itemreceiptSearchJoinValues,
  itemrevision: itemrevisionSearchJoinValues,
  itemsupplyplan: itemsupplyplanSearchJoinValues,
  job: jobSearchJoinValues,
  jobstatus: jobstatusSearchJoinValues,
  jobtype: jobtypeSearchJoinValues,
  journalentry: journalentrySearchJoinValues,
  kititem: kititemSearchJoinValues,
  laborbasedprojectrevenuerule: laborbasedprojectrevenueruleSearchJoinValues,
  landedcost: landedcostSearchJoinValues,
  lead: leadSearchJoinValues,
  location: locationSearchJoinValues,
  lotnumberedassemblyitem: lotnumberedassemblyitemSearchJoinValues,
  lotnumberedinventoryitem: lotnumberedinventoryitemSearchJoinValues,
  manufacturingcosttemplate: manufacturingcosttemplateSearchJoinValues,
  manufacturingoperationtask: manufacturingoperationtaskSearchJoinValues,
  manufacturingrouting: manufacturingroutingSearchJoinValues,
  mapreducescript: mapreducescriptSearchJoinValues,
  markupitem: markupitemSearchJoinValues,
  massupdatescript: massupdatescriptSearchJoinValues,
  merchandisehierarchylevel: merchandisehierarchylevelSearchJoinValues,
  merchandisehierarchynode: merchandisehierarchynodeSearchJoinValues,
  merchandisehierarchyversion: merchandisehierarchyversionSearchJoinValues,
  message: messageSearchJoinValues,
  mfgplannedtime: mfgplannedtimeSearchJoinValues,
  msesubsidiary: msesubsidiarySearchJoinValues,
  nexus: nexusSearchJoinValues,
  noninventoryitem: noninventoryitemSearchJoinValues,
  note: noteSearchJoinValues,
  notetype: notetypeSearchJoinValues,
  opportunity: opportunitySearchJoinValues,
  orderschedule: orderscheduleSearchJoinValues,
  originatinglead: originatingleadSearchJoinValues,
  otherchargeitem: otherchargeitemSearchJoinValues,
  othername: othernameSearchJoinValues,
  othernamecategory: othernamecategorySearchJoinValues,
  partner: partnerSearchJoinValues,
  partnercategory: partnercategorySearchJoinValues,
  paycheck: paycheckSearchJoinValues,
  paycheckjournal: paycheckjournalSearchJoinValues,
  paymentitem: paymentitemSearchJoinValues,
  paymentmethod: paymentmethodSearchJoinValues,
  payrollbatch: payrollbatchSearchJoinValues,
  payrollitem: payrollitemSearchJoinValues,
  pctcompleteprojectrevenuerule: pctcompleteprojectrevenueruleSearchJoinValues,
  periodendjournal: periodendjournalSearchJoinValues,
  phonecall: phonecallSearchJoinValues,
  portlet: portletSearchJoinValues,
  pricebook: pricebookSearchJoinValues,
  pricelevel: pricelevelSearchJoinValues,
  priceplan: priceplanSearchJoinValues,
  pricing: pricingSearchJoinValues,
  pricinggroup: pricinggroupSearchJoinValues,
  projectexpensetype: projectexpensetypeSearchJoinValues,
  projecttask: projecttaskSearchJoinValues,
  projecttaskassignment: projecttaskassignmentSearchJoinValues,
  projecttemplate: projecttemplateSearchJoinValues,
  promotioncode: promotioncodeSearchJoinValues,
  prospect: prospectSearchJoinValues,
  purchasecontract: purchasecontractSearchJoinValues,
  purchaseorder: purchaseorderSearchJoinValues,
  purchaserequisition: purchaserequisitionSearchJoinValues,
  reallocateitem: reallocateitemSearchJoinValues,
  receiveinboundshipment: receiveinboundshipmentSearchJoinValues,
  resourceallocation: resourceallocationSearchJoinValues,
  restlet: restletSearchJoinValues,
  returnauthorization: returnauthorizationSearchJoinValues,
  revenuearrangement: revenuearrangementSearchJoinValues,
  revenuecommitment: revenuecommitmentSearchJoinValues,
  revenuecommitmentreversal: revenuecommitmentreversalSearchJoinValues,
  revenueplan: revenueplanSearchJoinValues,
  revrecschedule: revrecscheduleSearchJoinValues,
  revrectemplate: revrectemplateSearchJoinValues,
  role: roleSearchJoinValues,
  salesorder: salesorderSearchJoinValues,
  salesrole: salesroleSearchJoinValues,
  salestaxitem: salestaxitemSearchJoinValues,
  scheduledscript: scheduledscriptSearchJoinValues,
  scheduledscriptinstance: scheduledscriptinstanceSearchJoinValues,
  scriptdeployment: scriptdeploymentSearchJoinValues,
  serializedassemblyitem: serializedassemblyitemSearchJoinValues,
  serializedinventoryitem: serializedinventoryitemSearchJoinValues,
  serviceitem: serviceitemSearchJoinValues,
  shipitem: shipitemSearchJoinValues,
  shoppingcart: shoppingcartSearchJoinValues,
  solution: solutionSearchJoinValues,
  statisticaljournalentry: statisticaljournalentrySearchJoinValues,
  storepickupfulfillment: storepickupfulfillmentSearchJoinValues,
  subscription: subscriptionSearchJoinValues,
  subscriptionchangeorder: subscriptionchangeorderSearchJoinValues,
  subscriptionline: subscriptionlineSearchJoinValues,
  subscriptionplan: subscriptionplanSearchJoinValues,
  subsidiary: subsidiarySearchJoinValues,
  subtotalitem: subtotalitemSearchJoinValues,
  suitelet: suiteletSearchJoinValues,
  supplychainsnapshot: supplychainsnapshotSearchJoinValues,
  supportcase: supportcaseSearchJoinValues,
  task: taskSearchJoinValues,
  taxacct: taxacctSearchJoinValues,
  taxdetail: taxdetailSearchJoinValues,
  taxgroup: taxgroupSearchJoinValues,
  taxperiod: taxperiodSearchJoinValues,
  taxtype: taxtypeSearchJoinValues,
  term: termSearchJoinValues,
  timebill: timebillSearchJoinValues,
  timeentry: timeentrySearchJoinValues,
  timesheet: timesheetSearchJoinValues,
  topic: topicSearchJoinValues,
  transaction: transactionSearchJoinValues,
  transferorder: transferorderSearchJoinValues,
  unitstype: unitstypeSearchJoinValues,
  usereventscript: usereventscriptSearchJoinValues,
  vendor: vendorSearchJoinValues,
  vendorbill: vendorbillSearchJoinValues,
  vendorcategory: vendorcategorySearchJoinValues,
  vendorcredit: vendorcreditSearchJoinValues,
  vendorpayment: vendorpaymentSearchJoinValues,
  vendorreturnauthorization: vendorreturnauthorizationSearchJoinValues,
  vendorsubsidiaryrelationship: vendorsubsidiaryrelationshipSearchJoinValues,
  website: websiteSearchJoinValues,
  winlossreason: winlossreasonSearchJoinValues,
  workflowactionscript: workflowactionscriptSearchJoinValues,
  workorder: workorderSearchJoinValues,
  workorderclose: workordercloseSearchJoinValues,
  workordercompletion: workordercompletionSearchJoinValues,
  workorderissue: workorderissueSearchJoinValues,
  workplace: workplaceSearchJoinValues
};
