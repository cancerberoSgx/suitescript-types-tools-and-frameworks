...
// Search Types for record Bundle Installation Script (bundleinstallationscript)

// Search Columns

/** Bundle Installation Script (bundleinstallationscript) Search Columns definition */
export interface bundleinstallationscriptSearchColumn {
...
/** Bundle Installation Script (bundleinstallationscript) Search Filters definition */
export interface bundleinstallationscriptSearchFilter {
/** After Install Function (afterinstallfunction: text) */
  afterinstallfunction?: string;
  /** After Submit Function (aftersubmitfunction: text) */
  aftersubmitfunction?: string;
...
/** Bundle Installation Script (bundleinstallationscript) Search Joins definitions. */
export interface bundleinstallationscriptSearchJoinTypes {
/** bundleinstallationscript's user search filter. User. Actual name: Employee. */
  user: 'user';
}
...
/** Bundle Installation Script (bundleinstallationscript) Search Filter Type definitions. */
export interface bundleinstallationscriptSearchFilterTypes {
...
/** Bundle Installation Script (bundleinstallationscript) Search Column Type definitions. */
export interface bundleinstallationscriptSearchColumnTypes {
afterinstallfunction: 'text';
  aftersubmitfunction: 'text';
  afterupdatefunction: 'text';
  beforeinstallfunction: 'text';
