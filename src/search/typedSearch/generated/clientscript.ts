...
// Search Types for record Client Script (clientscript)

// Search Columns

/** Client Script (clientscript) Search Columns definition */
export interface clientscriptSearchColumn {
...
/** Client Script (clientscript) Search Filters definition */
export interface clientscriptSearchFilter {
/** After Install Function (afterinstallfunction: text) */
  afterinstallfunction?: string;
  /** After Submit Function (aftersubmitfunction: text) */
  aftersubmitfunction?: string;
...
/** Client Script (clientscript) Search Joins definitions. */
export interface clientscriptSearchJoinTypes {
/** clientscript's user search filter. User. Actual name: Employee. */
  user: 'user';
}
...
/** Client Script (clientscript) Search Filter Type definitions. */
export interface clientscriptSearchFilterTypes {
...
/** Client Script (clientscript) Search Column Type definitions. */
export interface clientscriptSearchColumnTypes {
afterinstallfunction: 'text';
  aftersubmitfunction: 'text';
  afterupdatefunction: 'text';
  beforeinstallfunction: 'text';
