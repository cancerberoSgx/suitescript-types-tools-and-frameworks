...
// Search Types for record Portlet (portlet)

// Search Columns

/** Portlet (portlet) Search Columns definition */
export interface portletSearchColumn {
...
/** Portlet (portlet) Search Filters definition */
export interface portletSearchFilter {
/** After Install Function (afterinstallfunction: text) */
  afterinstallfunction?: string;
  /** After Submit Function (aftersubmitfunction: text) */
  aftersubmitfunction?: string;
...
/** Portlet (portlet) Search Joins definitions. */
export interface portletSearchJoinTypes {
/** portlet's user search filter. User. Actual name: Employee. */
  user: 'user';
}
...
/** Portlet (portlet) Search Filter Type definitions. */
export interface portletSearchFilterTypes {
...
/** Portlet (portlet) Search Column Type definitions. */
export interface portletSearchColumnTypes {
afterinstallfunction: 'text';
  aftersubmitfunction: 'text';
  afterupdatefunction: 'text';
  beforeinstallfunction: 'text';
