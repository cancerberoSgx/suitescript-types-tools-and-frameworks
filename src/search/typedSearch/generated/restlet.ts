...
/** Restlet (restlet) Search Columns definition */
export interface restletSearchColumn {
...
/** Restlet (restlet) Search Filters definition */
export interface restletSearchFilter {
/** After Install Function (afterinstallfunction: text) */
  afterinstallfunction?: string;
  /** After Submit Function (aftersubmitfunction: text) */
  aftersubmitfunction?: string;
...
/** Restlet (restlet) Search Joins definitions. */
export interface restletSearchJoinTypes {
/** restlet's user search filter. User. Actual name: Employee. */
  user: 'user';
}
...
/** Restlet (restlet) Search Filter Type definitions. */
export interface restletSearchFilterTypes {
...
/** Restlet (restlet) Search Column Type definitions. */
export interface restletSearchColumnTypes {
afterinstallfunction: 'text';
  aftersubmitfunction: 'text';
  afterupdatefunction: 'text';
  beforeinstallfunction: 'text';
