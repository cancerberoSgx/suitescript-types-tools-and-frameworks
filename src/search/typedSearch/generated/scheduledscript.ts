...
// Search Types for record Scheduled Script (scheduledscript)

// Search Columns

/** Scheduled Script (scheduledscript) Search Columns definition */
export interface scheduledscriptSearchColumn {
...
/** Scheduled Script (scheduledscript) Search Filters definition */
export interface scheduledscriptSearchFilter {
/** After Install Function (afterinstallfunction: text) */
  afterinstallfunction?: string;
  /** After Submit Function (aftersubmitfunction: text) */
  aftersubmitfunction?: string;
...
/** Scheduled Script (scheduledscript) Search Joins definitions. */
export interface scheduledscriptSearchJoinTypes {
/** scheduledscript's user search filter. User. Actual name: Employee. */
  user: 'user';
}
...
/** Scheduled Script (scheduledscript) Search Filter Type definitions. */
export interface scheduledscriptSearchFilterTypes {
...
/** Scheduled Script (scheduledscript) Search Column Type definitions. */
export interface scheduledscriptSearchColumnTypes {
afterinstallfunction: 'text';
  aftersubmitfunction: 'text';
  afterupdatefunction: 'text';
  beforeinstallfunction: 'text';
