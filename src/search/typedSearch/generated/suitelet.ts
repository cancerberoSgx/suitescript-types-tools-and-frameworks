...
// Search Types for record Suitelet (suitelet)

// Search Columns

/** Suitelet (suitelet) Search Columns definition */
export interface suiteletSearchColumn {
...
/** Suitelet (suitelet) Search Filters definition */
export interface suiteletSearchFilter {
/** After Install Function (afterinstallfunction: text) */
  afterinstallfunction?: string;
  /** After Submit Function (aftersubmitfunction: text) */
  aftersubmitfunction?: string;
...
/** Suitelet (suitelet) Search Joins definitions. */
export interface suiteletSearchJoinTypes {
/** suitelet's user search filter. User. Actual name: Employee. */
  user: 'user';
}
...
/** Suitelet (suitelet) Search Filter Type definitions. */
export interface suiteletSearchFilterTypes {
...
/** Suitelet (suitelet) Search Column Type definitions. */
export interface suiteletSearchColumnTypes {
afterinstallfunction: 'text';
  aftersubmitfunction: 'text';
  afterupdatefunction: 'text';
  beforeinstallfunction: 'text';
