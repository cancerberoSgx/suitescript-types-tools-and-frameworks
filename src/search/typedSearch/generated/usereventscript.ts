...
// Search Types for record Userevent Script (usereventscript)

// Search Columns

/** Userevent Script (usereventscript) Search Columns definition */
export interface usereventscriptSearchColumn {
...
/** Userevent Script (usereventscript) Search Filters definition */
export interface usereventscriptSearchFilter {
/** After Install Function (afterinstallfunction: text) */
  afterinstallfunction?: string;
  /** After Submit Function (aftersubmitfunction: text) */
  aftersubmitfunction?: string;
...
/** Userevent Script (usereventscript) Search Joins definitions. */
export interface usereventscriptSearchJoinTypes {
/** usereventscript's user search filter. User. Actual name: Employee. */
  user: 'user';
}
...
/** Userevent Script (usereventscript) Search Filter Type definitions. */
export interface usereventscriptSearchFilterTypes {
...
/** Userevent Script (usereventscript) Search Column Type definitions. */
export interface usereventscriptSearchColumnTypes {
afterinstallfunction: 'text';
  aftersubmitfunction: 'text';
  afterupdatefunction: 'text';
  beforeinstallfunction: 'text';
